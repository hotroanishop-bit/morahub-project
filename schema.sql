...
CREATE TABLE `BankSettings` (
  ...
  `bankCode` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MB',
...
CREATE TABLE `site_settings` (
  ...
  `emailVerifyRequired` tinyint(1) NOT NULL DEFAULT '0',
  `referralEnabled` tinyint(1) NOT NULL DEFAULT '1',
  `referralReward` int NOT NULL DEFAULT '50000',
  `signupCredit` int NOT NULL DEFAULT '0',
  `telegramVerifyCredit` int NOT NULL DEFAULT '50000',
  `bankAccountNumber` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bankActive` tinyint(1) NOT NULL DEFAULT '0',
  `bankPassword` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bankUsername` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tickets` (
  ...
  `issueType` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `autoResponded` tinyint(1) DEFAULT '0',
  `wrongInfo` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-06-04 10:32:57
